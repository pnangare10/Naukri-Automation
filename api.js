...
const searchJobsAPI = (pageNo, keywords, authorization = accessToken) =>
  fetch(
    `https://www.naukri.com/jobapi/v3/search?noOfResults=20&urlType=search_by_key_loc&searchType=adv&location=pune%2C%20mumbai%2C%20bengaluru%2C%20bangalore&keyword=SAP%20Basis%20Consultant&sort=p&pageNo=${pageNo}&experience=3&ctcFilter=6to10&ctcFilter=10to15&ctcFilter=15to25&ctcFilter=25to50&ctcFilter=50to75&ctcFilter=75to100&k=${keywords}&l=pune%2C%20mumbai%2C%20bengaluru%2C%20bangalore&nignbevent_src=jobsearchDeskGNB&experience=3&ctcFilter=6to10&ctcFilter=10to15&ctcFilter=15to25&ctcFilter=25to50&ctcFilter=50to75&ctcFilter=75to100&src=cluster&latLong=18.7506117_73.8764436&sid=17143714288347830_8`,
    {
      headers: {
        accept: "application/json",
        "accept-language": "en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7",
...
const loginAPI = (creds) => 
  ...
  "headers": {
    ...
    "sec-fetch-site": "same-origin",
    "systemid": "jobseeker",
    "cookie": "HitsFromTieup=23531; wExp=N; TieupFromTMS=105; _t_ds=396904e61716048512-12396904e6-0396904e6; J=0; bm_mi=7358C91289F218125F282A7466227C83~~1; ak_bmsc=9A7856F32452B565354E040F52D7BEFF~000000000000000000000000000000~; _ga=GA1.1.1029791969.1716048514; _gcl_au=1.1.1372381662.1716048515; PHPSESSID=5f0a9uhe1lqtgu5tvnoa3t47r6; MYNAUKRI[UNID]=8cdb4e75d73f4f71b0d8bac441c6b12c; test=naukri.com; _t_us=6648D320; _t_s=direct; _t_r=1030%2F%2F; persona=default; bm_sv=34544969B8D10C7A91BAF5E21AE931D4~~1; HOWTORT=cl=1716048677342&r=https%3A%2F%2Fwww.naukri.com%2F&ul=1716048672167&hd=1716048672295&nu=https%3A%2F%2Flogin.naukri.com%2FnLogin%2FLogin.php; _ga_K2YBNZVRLL=GS1.1.1716048514.1.1.1716048685.47.0.0; _ga_T749QGK6MQ=GS1.1.1716048674.1.1.1716048686.0.0.0",
